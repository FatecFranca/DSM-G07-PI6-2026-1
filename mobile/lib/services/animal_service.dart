...
class AnimalService {
  ...
  Future<Map<String, dynamic>> getIaRecomendacao(String animalId, double pesoIdeal) async {
    final uri = Uri.parse('$_pythonApiBaseUrl/animal/$animalId/ia-recomendacao?pesoIdeal=$pesoIdeal');
